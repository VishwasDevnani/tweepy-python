...
class TwitterAuthenticator():
    """
    class for authenticating tweets
    """
...
if __name__ == '__main__':
    ...
    data = twitter_client.get_user_timeline_tweets(10)
    for tweet in range(10):
        with open('modiji.txt','a') as nm:
            nm.write(str(data[tweet]))


    # twitter_streamer = TwitterStreamer()
    # twitter_streamer.stream_tweets('tweets.json', hash_tag_list)
